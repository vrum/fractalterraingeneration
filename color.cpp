...
color::color(const string& cname){
	...
	//if it starts with a number then it's a specific color
	...
	{
		if (cname == "purple" || cname == "Purple" || cname == "PURPLE")
		{
			fullval=0x780078FF;
		}
		else if (cname == "black" || cname == "Black" || cname == "BLACK")
		{
			fullval=0x000000FF;
		}
		else if (cname == "white" || cname == "White" || cname == "WHITE")
		{
			fullval=0xFFFFFFFF;
		}
		else if (cname == "red" || cname == "Red" || cname == "RED")
		{
			fullval=0xFF0000FF;
		}
		else if (cname == "blue" || cname == "Blue" || cname == "BLUE")
		{
			fullval=0x0000FFFF;
		}
		else if (cname == "green" || cname == "Green" || cname == "GREEN")
		{
			fullval=0x00FF00FF;
		}
		else
		{
			cout << "Warning: color name \'" << cname << "\' not recognized." << endl;
			fullval=0x000000FF;
		}
	}
}
